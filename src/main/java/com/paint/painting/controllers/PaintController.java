...
public class PaintController {
    ...
    public ResponseEntity<Paint> createPaint(@RequestParam("file") MultipartFile file,
        ...
        paint = objectMapper.readValue(metadataJson, Paint.class);

        System.out.println("Paint object created:");
        System.out.println("Title: " + paint.getTitle());
        System.out.println("Description: " + paint.getDescription());
        System.out.println("Price: " + paint.getPrice());
        System.out.println("Quantity: " + paint.getQuantity());
        System.out.println("Artist ID: " + paint.getArtist().getId());
        System.out.println("Category ID: " + paint.getCategory().getId());
            // ObjectMapper objectMapper = new ObjectMapper();
            // paint = objectMapper.readValue(metadataJson, Paint.class);
